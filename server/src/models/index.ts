/**
 * SkillSense AI - Models Index
 */

export { User, IUser, IUserProfile } from './user.model';
export { Skill, ISkill, IProficiencyLevel } from './skill.model';
export { Role, IRole, IRoleSkillRequirement, ISalaryRange } from './role.model';
